...
motd = ['cock',
        'developed in collaboration with federal informants',
        'runs on windows phone 8',
        'developed for Gentoo',
        'approved by Richard M. Stallman',
        'Hack the Planet!',
        'developed for Windows Vista',
        'It just works.',
        'Developed in VB6.',
        'Now with a one inch wider screen!',
        'works best on Windows',
        'fuck whitehats',
        'im gay',
        '"WHITE HATS I HATE" - tropic',
        'now with integrated mempodipper!',
        'tarsend 2013',
		"...and I'm a Mormon."]
...
def symhunt(): 
    ...
    for lindir in vmlinux: 
        if not os.path.exists(lindir):
            ...
            continue
        try:
            os.system("nm {0} &> {1}".format(lindir, ".sysmap")) #thanks to huey for this code snippet!
        except:
